...
const T = {
  ko: {
    ...
    // Privacy
    'privacy-hero-label': 'Privacy Policy',
    'privacy-hero-title': '개인정보처리방침',
    'privacy-intro': 'Code Builder(이하 "회사")는 roblox.code-builder.kr(이하 "사이트") 이용자의 개인정보를 소중히 다루며, 아래와 같이 개인정보를 처리합니다.',
    'privacy-h1': '1. 수집하는 개인정보 항목',
    'privacy-p1': '문의(Contact) 폼 제출 시 이름, 이메일, 소속기관(선택), 문의 내용을 수집합니다. 플레이 영상 제보(Share) 시 이메일과 업로드하신 영상 파일을 수집합니다. 사이트 방문 시 Google Analytics/Google Tag Manager를 통해 방문 통계(쿠키 포함)가 수집될 수 있습니다.',
    'privacy-h2': '2. 수집 목적',
    'privacy-p2': '문의 응대 및 회신, 제보 영상 확인 및 감사 메일 발송, 사이트 이용 통계 분석 및 서비스 개선을 위해 이용합니다.',
    'privacy-h3': '3. 보유 및 이용 기간',
    'privacy-p3': '수집 목적을 달성한 후에는 지체 없이 파기합니다. 단, 관계 법령에 따라 보존이 필요한 경우 해당 기간 동안 보관합니다.',
    'privacy-h4': '4. 제3자 제공 및 위탁',
    'privacy-p4': '회사는 원칙적으로 이용자의 개인정보를 외부에 제공하지 않습니다. 다만 제보 영상은 저장을 위해 Google Drive(Google LLC)를 이용하며, 이 과정에서 Google의 개인정보처리방침이 함께 적용될 수 있습니다.',
    'privacy-h5': '5. 이용자의 권리',
    'privacy-p5': '이용자는 언제든지 자신의 개인정보에 대한 열람, 정정, 삭제를 요청할 수 있으며, 아래 문의처로 연락하시면 신속히 조치합니다.',
    'privacy-h6': '6. 문의처',
    'privacy-p6': '개인정보 관련 문의: edu@haedal.io',
    'privacy-effective': '시행일: 2026년 7월 14일',

    // Terms
    'terms-hero-label': 'Terms of Service',
    'terms-hero-title': '이용약관',
    'terms-h1': '1. 목적',
    'terms-p1': '이 약관은 Code Builder(이하 "회사")가 운영하는 roblox.code-builder.kr(이하 "사이트") 이용과 관련하여 회사와 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.',
    'terms-h2': '2. 서비스 내용',
    'terms-p2': '사이트는 로블록스 코딩 게임 Code Builder를 소개하고, 문의 접수 및 플레이 영상 제보를 위한 채널을 제공합니다. 실제 게임 플레이는 Roblox 플랫폼에서 이루어지며, 이에 대해서는 Roblox Corporation의 별도 이용약관이 적용됩니다.',
    'terms-h3': '3. 이용자의 의무',
    'terms-p3': '이용자는 사이트 이용 시 허위 정보를 제공하거나, 타인의 권리를 침해하거나, 사이트 운영을 방해하는 행위를 해서는 안 됩니다.',
    'terms-h4': '4. 콘텐츠의 저작권',
    'terms-p4': '사이트에 게시된 텍스트, 이미지, 영상 등 콘텐츠의 저작권은 회사에 있으며, 회사의 사전 동의 없이 이를 복제·배포·전송할 수 없습니다.',
    'terms-h5': '5. 면책조항',
    'terms-p5': '회사는 사이트에서 제공하는 정보의 정확성을 위해 노력하지만 이를 보증하지 않으며, 외부 링크(Roblox 등)를 통해 발생한 문제에 대해서는 책임을 지지 않습니다.',
    'terms-h6': '6. 약관의 변경',
    'terms-p6': '이 약관은 필요한 경우 사전 고지를 거쳐 변경될 수 있으며, 변경된 약관은 사이트에 게시함으로써 효력이 발생합니다.',
    'terms-h7': '7. 문의처',
    'terms-p7': '약관 관련 문의: edu@haedal.io',
    'terms-effective': '시행일: 2026년 7월 14일',
  },
  ...
  en: {
    ...
    'privacy-intro': 'Code Builder ("the Company") values the privacy of visitors to roblox.code-builder.kr ("the Site") and processes personal data as described below.',
    'privacy-h1': '1. Personal Data We Collect',
    'privacy-p1': 'When you submit the Contact form, we collect your name, email, organization (optional), and inquiry content. When you submit a gameplay video via the Share page, we collect your email and the uploaded video file. Visiting the Site may also collect visit statistics (including cookies) via Google Analytics/Google Tag Manager.',
    'privacy-h2': '2. Purpose of Collection',
    'privacy-p2': 'We use this data to respond to inquiries, review submitted videos and send thank-you emails, and analyze site usage to improve our service.',
    'privacy-h3': '3. Retention Period',
    'privacy-p3': 'Data is destroyed without delay once its purpose has been fulfilled, unless a longer retention period is required by applicable law.',
    'privacy-h4': '4. Third-Party Sharing',
    'privacy-p4': 'The Company does not share personal data with third parties in principle. Submitted videos are stored using Google Drive (Google LLC), to which Google\'s own privacy policy may also apply.',
    'privacy-h5': '5. Your Rights',
    'privacy-p5': 'You may request access to, correction of, or deletion of your personal data at any time by contacting us below.',
    'privacy-h6': '6. Contact',
    'privacy-p6': 'For privacy inquiries: edu@haedal.io',
    'privacy-effective': 'Effective date: July 14, 2026',

    // Terms
    'terms-hero-label': 'Terms of Service',
    'terms-hero-title': 'Terms of Service',
    'terms-h1': '1. Purpose',
    'terms-p1': 'These Terms govern the rights, obligations, and responsibilities of the Company and users in connection with the use of roblox.code-builder.kr ("the Site"), operated by Code Builder ("the Company").',
    'terms-h2': '2. Description of Service',
    'terms-p2': 'The Site introduces the Roblox coding game Code Builder and provides channels for inquiries and gameplay video submissions. Actual gameplay takes place on the Roblox platform and is separately governed by Roblox Corporation\'s own Terms of Service.',
    'terms-h3': '3. User Obligations',
    'terms-p3': 'Users must not provide false information, infringe on the rights of others, or interfere with the operation of the Site.',
    'terms-h4': '4. Content Copyright',
    'terms-p4': 'The copyright to text, images, videos, and other content posted on the Site belongs to the Company, and may not be reproduced, distributed, or transmitted without the Company\'s prior consent.',
    'terms-h5': '5. Disclaimer',
    'terms-p5': 'The Company strives for accuracy in the information provided on the Site but does not guarantee it, and is not liable for issues arising from external links (such as Roblox).',
    'terms-h6': '6. Changes to These Terms',
    'terms-p6': 'These Terms may be changed with prior notice as needed, and changes take effect once posted on the Site.',
    'terms-h7': '7. Contact',
    'terms-p7': 'For questions about these Terms: edu@haedal.io',
    'terms-effective': 'Effective date: July 14, 2026',
  },
};
